...
import { doc, getDoc, collection, query, where, orderBy, onSnapshot, setDoc, deleteDoc, Timestamp } from 'firebase/firestore';
        ...
        <div className="px-8 pb-8">
          <div className="relative flex justify-between items-end -mt-12 mb-6">
            ...
            <div className="flex gap-3">
              {user?.uid === targetUid ? (
                <button className="px-6 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-indigo-200 dark:shadow-none">
                  Edit Profile
                </button>
              ) : (
                <>
